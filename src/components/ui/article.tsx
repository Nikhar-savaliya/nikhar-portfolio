...
const Article = ({ title, link, description, time }: articleData) => {
  return (
    <div className=" p-3 m-3 my-4 px-4 max-w-5xl border-2  rounded-lg bg-card text-card-foreground mx-auto">
      <div className="px-2">
        ...
        <p className="text-[10px] text-primary font-bold pb-1">{`${time} minutes read`}</p>
